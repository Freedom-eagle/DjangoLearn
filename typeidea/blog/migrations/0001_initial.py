# -*- coding: utf-8 -*-
# Generated by Django 1.11.29 on 2022-11-16 06:44
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contact', models.TextField(help_text='正文必须为MarkDown格式', verbose_name='正文')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.PositiveIntegerField(choices=[(1, '正常'), (0, '删除')], default='STATUS_NORMAL', verbose_name='状态')),
                ('created_time', models.DateTimeField(auto_now_add=True, verbose_name='创建时间')),
                ('owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='作者')),
            ],
            options={
